...
if dataset_mode == 'hardfake':
    ...
    raise ValueError("Invalid dataset_mode. Choose 'hardfake', 'rvf10k', '140k', '190k', or '200k'.")
...
# Visualization for test samples
if dataset_mode == '190k':
    val_data = []
...
with torch.no_grad():
    for i, idx in enumerate(random_indices):
        ...
        if dataset_mode == '140k':
            ...
            if dataset_mode == '190k':
                split = 'Test' if row['path'].startswith(os.path.join(data_dir, 'Test')) else 'Validation'
